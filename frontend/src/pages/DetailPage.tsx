...
import OneMenuItem from "@/components/OneMenuItem";
...
const DetailPage = () => {
    ...
    const addToCart = (menuItem: MenuItemType) => {
        setCartItems((prevCartItems) => {
            // 1. check if item is in cart already
            ...
            // 3. if item not in cart, add as new item
            else {
                updatedCartItems = [
                    ...prevCartItems, {
                        _id: menuItem._id,
            ...
            <div className="grid md:grid-cols-[4fr_2fr] gap-5 md:px-32">
                <div className="flex flex-col gap-4">
                    ...
                    {restaurant.menuItems.map((menuItem) => (
                        <OneMenuItem menuItem={menuItem} addToCart={() => addToCart(menuItem)} />
                    ))}
                </div>
